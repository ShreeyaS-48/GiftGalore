...
import { getAllOrders, getOrderAnalytics, getOrdersForUser, getSalesAnalytics, orderDelivered} from "../../controllers/ordersController.js";
...
router.route("/sales-analytics")
.get(verifyRoles(ROLES_LIST.Admin),getSalesAnalytics); 

router.route("/order-analytics")
