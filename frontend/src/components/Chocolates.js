...
const Chocolates = () => {
    const {searchedChocolates, isLoading, fetchError,  handlePriceFilter, handleReviewsFilter, handleRatingFilter} = useContext(DataContext);
    return (
        <>
            ...
            {!isLoading && !fetchError &&
                    <main className="items-page">
                        ...
                        <ul className='items-display'>
                            {searchedChocolates.map(product=>
                             <Product
                             key = {product._id}
                             product={product}
                         />)
