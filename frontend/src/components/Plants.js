...
const Plants = () => {
    const {searchedPlants, isLoading, fetchError,  handlePriceFilter, handleReviewsFilter, handleRatingFilter} = useContext(DataContext);
    return (
        <>
            {isLoading && <p style={{margin: "5px"}}>Loading Plants...</p>}
